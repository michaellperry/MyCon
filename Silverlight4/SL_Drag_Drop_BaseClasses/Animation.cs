...
namespace SL_Drag_Drop_BaseClasses
{
    ...
    internal class Animation
    {
        ...
        internal static Storyboard ReturnDragToOriginalPosition(DependencyObject objectToBeAnimated, 
            Point CurrentPosition, Point FinalPosition, double duration, IEasingFunction easingfunction)
        {
        ...
        /// <param name="easingfunction"></param>
        /// <returns></returns>
        private static EasingDoubleKeyFrame getEasingDoubleKeyFrame(double seconds, double value, IEasingFunction easingfunction)
        {
